...
function whiteBlock(obj, list) {
    if (!is.object(obj)) {
        throw TypeError('whiteBlock first param must be Object');
    }

    if (!is.array(list)) {
        throw TypeError('whiteBlock second param must be Array');
    }

    return list.reduce((pre, cur) => {
        if (!is.undefined(obj[cur])) {
            pre[cur] = obj[cur];
            return pre;
        }
    }, {});
